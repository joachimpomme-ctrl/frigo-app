    ...
    icon: (active: boolean) => (
      <svg width="22" height="22" fill="none" viewBox="0 0 24 24">
        <path
          ...
          strokeLinejoin="round"
        />
        <path d="M3 6h18" stroke="currentColor" strokeWidth={active ? 2 : 1.5}/>
        <path d="M16 10a4 4 0 01-8 0" stroke="currentColor" strokeWidth={active ? 2 : 1.5} strokeLinecap="round"/>
      </svg>
    ),
  },
  {
